...
std::vector<ov::genai::EncodedImage> InputsEmbedderLLaVANext::encode_images(const std::vector<ov::Tensor>& images, const ov::AnyMap& config_map, const bool& is_video) {
    if (is_video) {
